...
struct GraphPractice: View {
    
    
    var body: some View {
        ZStack {
            
            LineGraphProva(data: sampleData)
                .frame(height: 250)
                .padding(.top, 25)
        }
...
let sampleData: [CGFloat] = [900, 400, 300, 700, 250, 150, 550, 600, 1250, 450, 550, 600]
